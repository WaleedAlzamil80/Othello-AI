...
class GameController:
    ...
    def draw_top_bar(board):
        ...
        if board.is_done():
            ...
            SCREEN.blit(turn_text, turn_text.get_rect(center=(BOARD_BUTTON_CENTER, HEIGHT - 350)))
        ...
        SCREEN.blit(turn_text, turn_text.get_rect(center=turn_center))
    ...
    def draw_tile(row, col, value, square_size):
        ...
        pygame.draw.rect(SCREEN, (0,0,0) , tile_border, 1)
        tile = tile_border.inflate(-1, -1)
        pygame.draw.rect(SCREEN, Colors.BOARD, tile)
        
        circle_center = tile.center
        if value == -1:
            pygame.draw.circle(SCREEN, (255, 255, 255), circle_center, 0.8 * square_size // 2)
        elif value == 1:
            pygame.draw.circle(SCREEN, (0, 0, 0), circle_center, 0.8 * square_size // 2)
